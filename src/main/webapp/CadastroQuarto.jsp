...
<body>
    <c:set var="baseURL" value="${pageContext.request.contextPath}${applicationScope.URL_BASE}/QuartoControlador" />
    ...
    <nav>
        <ul>
            ...
            <li><a href="${baseURL}">Quartos</a></li>
    ...
    <form action="${baseURL}" method="GET">
        ...
        <label for="nome">Nome/Número:</label><br>
        <input type="text" id="nome" name="nome" value="${nome}" required><br>

        <label for="andar">Andar:</label><br>
        <input type="text" id="andar" name="andar" value="${andar}"><br>

        <label for="plano">Plano:</label><br>
        <input type="text" id="plano" name="plano" value="${plano}"><br>
        
        <label for="preco">Preço Diária:</label><br>
        ...
        <tbody>
            <c:forEach var="quarto" items="${quartos}">
                <tr>
                    ...
                    <td>${quarto.preco}</td>
                    <td>
                        <a href="${baseURL}?opcao=editar&id=${quarto.id}">Editar</a>
                        <a href="${baseURL}?opcao=excluir&id=${quarto.id}">Excluir</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
