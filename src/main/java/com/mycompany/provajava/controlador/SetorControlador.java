...
public class SetorControlador extends HttpServlet {
    ...
    private void cadastrar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        obj.setRef(request.getParameter("ref"));
        dao.salvar(obj);
        encaminharParaPagina(request, response);
    }
    ...
    private void editar(HttpServletRequest request, HttpServletResponse response, String id) throws ServletException, IOException {
        Setor setor = dao.buscarPorId(Integer.parseInt(id));
        request.setAttribute("id", setor.getId());
        request.setAttribute("nome", setor.getNome());
        request.setAttribute("ref", setor.getRef());
