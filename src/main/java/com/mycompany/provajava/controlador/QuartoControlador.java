...
public class QuartoControlador extends HttpServlet {
    ...
    private void cadastrar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        obj.setAndar(request.getParameter("andar"));
        obj.setPlano(request.getParameter("plano"));
    ...
    private void editar(HttpServletRequest request, HttpServletResponse response, String id) throws ServletException, IOException {
        Quarto quarto = dao.buscarPorId(Integer.parseInt(id));
        request.setAttribute("id", quarto.getId());
        request.setAttribute("nome", quarto.getNome());
        request.setAttribute("andar", quarto.getAndar());
        request.setAttribute("plano", quarto.getPlano());
        request.setAttribute("preco", quarto.getPreco());
